...
public class Constants 
{
    ...
    // Launcher motor IDs
    public static final int LAUNCHER_TOP_RIGHT_MOTOR_ID          = 25; //TODO find right values for motor CAN IDs
    public static final int LAUNCHER_TOP_LEFT_MOTOR_ID           = 9;
    public static final int LAUNCHER_BOTTOM_MOTOR_ID             = 10;
    ...
    // Chamber PIDs
    public static final int CHAMBER_P                            = 0;
    public static final int CHAMBER_I                            = 0; 
    public static final int CHAMBER_D                            = 0;
    public static final int CHAMBER_F                            = 0;

    // Intake PIDs
    public static final int INTAKE_WHEEL_P                       = 0;
    public static final int INTAKE_WHEEL_I                       = 0; 
    public static final int INTAKE_WHEEL_D                       = 0;
    public static final int INTAKE_WHEEL_F                       = 0;

    // Launcher PIDs

    public static final int LAUNCHER_P                           = 0;
    public static final int LAUNCHER_I                           = 0;
    public static final int LAUNCHER_D                           = 0;
    public static final int LAUNCHER_F                           = 0;
